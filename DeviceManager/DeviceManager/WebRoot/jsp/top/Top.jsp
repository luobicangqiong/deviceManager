...
href="loginAction_loginOut" target="_parent" >退出系统</A> </DIV>
    <DIV style="DISPLAY: block; HEIGHT: 40px;font-size: 30px; margin-left: 330px;">设备管理系统</DIV>
    <DIV 
style="BACKGROUND-IMAGE: url(images/bg_nav.gif); BACKGROUND-REPEAT: repeat-x; HEIGHT: 30px">
      <TABLE cellSpacing=0 cellPadding=0 width="100%">
        <TBODY>
          <TR>
            <TD>
              <DIV><IMG src="Top.files/nav_pre.gif" align=absMiddle> 欢迎  <SPAN id=lblDep>设备管理部 [</SPAN> <%=name%> ] 光临  </DIV>
            </TD>
