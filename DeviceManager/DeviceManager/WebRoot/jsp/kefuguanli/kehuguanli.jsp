...
<!-- 							<button class="btn btn-default edit-cus " data-toggle="modal" data-target="#myModal2">
						...
						data-target="#myModal3">归还设备</button>
    	...
    	if(se!=""){
           ...
           url:'DeviceAction_queryAllDevice'
    		...
    		$("#dg").datagrid({
           	...
           	url:'DeviceBorrowAction_queryAllDeviceByName'
            //url:'keFuAction_queryAllCustom' //触发此action,带上参数searcValue
				...
				url:'<%=basePath%>DeviceBorrowAction_queryAllDeviceByName',
			...
			pageList:[ 5, 10, 15, 20 ],method:'get'">
							<thead>
								<tr>
									<th data-options="field:'deviceId',width:110 ,align : 'center', ">设备ID</th>
									...
									<th data-options="field:'deviceCount',width:110,align:'center'">数量</th>
...
//							结束
             ...
             type: "post",
           url: "DeviceBorrowAction_returnDevice",
            dataType: "json",
            data:{
