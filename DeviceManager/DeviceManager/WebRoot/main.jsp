...
<body class="easyui-layout">
	<div data-options="region:'north',border:false" style="height:111px;padding: 0px;">
	<iframe runat="server" src="jsp/top/Top.jsp"  width="100%" height="105" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes"></iframe>
	</div>
	...
	<div data-options="region:'center'" style="margin: -16px;">
		...
		<div class="easyui-tabs" style="width:900px;height:400px;", fit="true" border="false" id="tabs">
